...
namespace SocNetworkApp.API.Migrations
{
    ...
    [Migration("20190720162756_IdentityInitial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SocNetworkApp.API.Models.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("SocNetworkApp.API.Models.UserRole", b =>
                {
                    b.Property<Guid>("UserId");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("SocNetworkApp.API.Models.Role")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("SocNetworkApp.API.Models.User")
                        .WithMany()
            ...
            modelBuilder.Entity("SocNetworkApp.API.Models.UserRole", b =>
                {
                    b.HasOne("SocNetworkApp.API.Models.Role", "Role")
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade);
